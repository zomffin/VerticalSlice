...
Image of the graph event that activates/changes the T value of the shader. It edits the material properties directly.
...
I think it was an overall success. It's not the *most* organized, but it was organized enough for me to get through tasks and make consistent progress on the project. I think in the future, I'll continue operating this way, but I hope to refine it further and maybe find better ways to take and organize my notes. I think a possible tool I can use is the Obsidian note taking app. I used it a little bit, and I like how you can "connect" different notes. I think this is a way to bridge the gap with my affinity towards task step break-downs, but make it possible to see how different systems will interact. 
